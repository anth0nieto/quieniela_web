...
class ResultadoAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $resultados = DB::table('resultado_admins')->where('id_quiniela', '=', $id_quin)->get();
    ...
    {   
        ...
        $id_quin = session()->get('id_q1');
        $partidos = DB::table('partidos')->where('fecha', '=', $request['fecha_result'])->where('id_quiniela', '=', $id_quin)->get();
        ...
        if(count($partidos) !=0)
        {
            if(DB::table('resultado_admins')->where('id_partido', '=', $partidos[0]->id_partido)->count() == 0)
            {    
    ...
    public function edit($id)
    {
        ...
        $partidos = DB::table('partidos')->where('id_partido', '=', $id)->get();
