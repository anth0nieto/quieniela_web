...
<h3><font style="font-family: 'Permanent Marker',cursive,Arial;"  size="5">¡Tus creditos han sido aprobados, todo está listo para jugar!</font></h3>

<p><strong>Email           : </strong>{!!$user_email!!}</p>
<p><strong>Monto           : </strong>{!!$monto!!} Bs.</p>
<p><strong>Nro.Transacción : </strong>{!!$ultimosCuatro!!}</p>

<br><br>

<a href="http://www.quinielaganadora.com.ve" class="myButton" style="
	...
	text-shadow:0px 1px 0px #283966;">Ir a Quiniela Ganadora</a>
