                    ...
                    <ul class="nav" id="side-menu">
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo URL::to('/quiniela/create'); ?>"><i class='fa fa-plus fa-fw'></i> Agregar Quiniela</a>
                                </li>
                                <li>
                                    <a href="<?php echo URL::to('/quiniela'); ?>"><i class='fa fa-list-ol fa-fw'></i> Quinielas</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo URL::to('/gestionCreditos'); ?>"><i class='fa fa-list-ol fa-fw'></i> Creditos Pendientes</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo URL::to('/gestionPagos'); ?>"><i class='fa fa-list-ol fa-fw'></i> Pagos Pendientes</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo URL::to('/admin/create'); ?>"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                                </li>
                                <li>
                                    <a href="<?php echo URL::to('/admin'); ?>"><i class='fa fa-list-ol fa-fw'></i>Administradores</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('/showQuinielas'); ?>"><i class='fa fa-play fa-fw'></i>Jugar</a>
                        </li>
