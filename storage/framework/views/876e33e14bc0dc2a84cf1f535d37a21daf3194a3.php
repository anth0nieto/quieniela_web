	...
	<?php $__env->startSection('content'); ?>
		...
		<?php foreach($quinielas as $quiniela): ?>
			...
			<?php $num_user = DB::table('user_quinielas')->where('id_quiniela','=', $quiniela->id)
				...
				<tbody align="center">
				<td class="warning"> <!-- Trigger the modal with a button -->
					        ...
					        <div align="center">
					        	...
					        	<?php $lista_partidos = DB::table('partidos')
                                  ...
                                  <?php  
                                    ...
                                    $lista_partidos_2 = DB::table('partidos')
						        ...
						        <?php $i=0 ?>
								  ...
								  <li align="center"> 
								  	<div class="row">
								  		<div class="col-md-3"><img class="img-responsive" src="../images/<?php echo e($partidos->id_equipo); ?>.png"></div>
								  		<div class="col-md-6"><h4><?php echo e($partidos->id_local); ?> - <?php echo e($lista_partidos_2[$i]->id_visitante); ?> <P> <?php echo e($partidos->fecha); ?></h4></div>
								  		<div class="col-md-3"><img class="img-responsive" src="../images/<?php echo e($lista_partidos_2[$i]->id_equipo); ?>.png"></div>
								  	</div>
								  </li><br>
								<?php $i++ ?>
								<?php endforeach; ?>
				...
				<td class="warning"><button class="btn btn-success" value="<?php echo e(csrf_token()); ?>" <?php echo e($disponible); ?> >Inscribir</button></td>
