              ...
              <img src="images/logo11.png"  class="img-responsive" alt="/">
                        ...
                        <div style="min-width:220px; width: 100%;" align="center">
                                    ...
                                    <div class="input-group" style="width: 100%; min-width:60%;">
                                        <?php echo Form::text('username',null,['class'=>'form-control', 'placeholder'=>'Ingresa el usuario']); ?>
                        ...
                        <div class="col-md-12" align="center" style="padding-right: 15px;">
                        	...
                        	<div style="min-width:220px; width: 100%; margin-bottom: 45px;" align="center">
 						        ...
 						        <div class="col-md-4  " align="center" style="padding-right: 1px; padding-left: 1px; padding-top: 4px;" >
                              		<?php echo link_to('password/email', $title = '¿Olvidó su contraseña?', $attributes = ['class'=>'btn btn-warning', 'style'=>'padding-right: 0px; width: 100%; padding-left: 0px; font-size: 13px;  background-color: transparent; border-color:transparent;'], $secure = null); ?>

                                </div>

								<div class="col-md-4" align="center" style="padding-right: 1px; padding-left: 1px; padding-top: 4px;" >                                    
                                	<?php echo link_to_route('user.create', $title = 'Registrarse', $parameters = null, $attributes = ['class'=>'btn btn-primary', 'style'=>' width: 100%; padding-right: 15px; font-size: 13px;  background-color: #00695C; border-color:#00695C;']); ?>

                                </div>
                                                    

                                <div class="col-md-4" align="center" style="padding-right: 1px; padding-left: 1px; padding-top: 4px;" >                                    
                                	<?php echo Form::submit('Ingresar',['class'=>'btn btn-primary', 'style'=>'width: 100%; padding-right: 15px; font-size: 13px; background-color: #30456b; border-color: #30456b;']); ?>
					...
					<ul class="rslides" id="slider">
						 <li>	 
							...
							<div class="col-md-6 cap">
								...
								<?php echo link_to_route('user.create', $title = '¡Regístrate Ahora!', $parameters = null, $attributes = ['class'=>'btn btn-primary', 'style'=> 'background-color: #00695C;border-color: #30456b;']); ?>
